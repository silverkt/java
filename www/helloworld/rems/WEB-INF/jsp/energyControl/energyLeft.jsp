...
<div class="left-in">
                    ...
                    <div id="tab1" class="tab-panel" style="display: block;">
                        ...
                        <div class="nyfx-item select-item">
                            <div class="item-tit">
                                <label><%--<input type="checkbox" class="selectToggle">--%>指标</label>
                            </div>
                            <div class="item-txt">
                    ...
                    <c:if test="${not empty energyList_5}">
							<div class="nyfx-item">
								<div class="item-txt" style="margin-left:7px;padding-left: 0;" >
									...
									<p>
										<label>
											<input style="margin-right:1px;" name="radioClasspropertyname" value="${energyList_5.classinstanceid}" type="radio" />
